<?php
	...
	if(isset($_GET['edit_id']) && !empty($_GET['edit_id']))
	{
		...
		$stmt_edit = $DB_con->prepare('SELECT*  FROM users WHERE userid =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE users SET username=:uname, email=:uem,phone=:up,address=:uaddr,password=:upas,userprofile=:upic WHERE userid=:uid');
